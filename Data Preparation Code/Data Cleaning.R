...
per_100 <- read.csv("C:/Users/ryans/OneDrive/Desktop/Spring 2021/Sports Analytics/Basketball/NBA-player-and-lineup-clustering/Data/2019_per_100.csv") %>%
  clean_names() %>%
  ...
  filter(mp > 30) %>%
  select(-c(x))
advanced <- read.csv("C:/Users/ryans/OneDrive/Desktop/Spring 2021/Sports Analytics/Basketball/NBA-player-and-lineup-clustering/Data/2019_advanced.csv") %>%
  clean_names() %>%
...
shooting <- read.csv("C:/Users/ryans/OneDrive/Desktop/Spring 2021/Sports Analytics/Basketball/NBA-player-and-lineup-clustering/Data/2019_shooting.csv") %>%
  clean_names() %>%
  filter(mp > 30) %>%
...
cleaned_data_2019 <- data_2019 %>%
  ...
  select(player, age, attempts_0_10, percent_0_10, attempts_dunk, x_of_fg_ast_d_2p,
         ...
         blk_percentage, stl_percentage, pf, orb_percentage, drb_percentage)
  
write.csv(cleaned_data_2019, "C:/Users/ryans/OneDrive/Desktop/Spring 2021/Sports Analytics/Basketball/NBA-player-and-lineup-clustering/Data/cleaned_data_2019.csv")
